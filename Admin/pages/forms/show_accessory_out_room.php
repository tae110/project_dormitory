...
<head>
    ...
    <title>ข้อมูลสิ่งอำนวยความสะดวก ในอาคาร</title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>ข้อมูลสิ่งอำนวยความสะดวก ในอาคาร</h2>
            </div>
            <!-- Input -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ข้อมูลสิ่งอำนวยความสะดวก ในอาคาร
                                <!-- <small>ข้อมูลสิ่งอำนวยความสะดวก ในอาคาร</small> -->
                            </h2>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <a href="../tables/manage_dormitory.php" type="submit"
                                            name="submit_update_accessory_out_room"
