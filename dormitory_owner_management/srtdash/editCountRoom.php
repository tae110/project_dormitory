...
include "./connectDB.php";
                                        ...
                                        <form action="" method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label for="inputEmail4">จำนวนห้องที่ว่าง</label>
                                                    <input type="text" class="form-control" required
                                                        name="dt_count_room" value="<?=$data["dt_count_room"];?>"
                                                        placeholder="">
                                                </div>
                                            </div>
    ...
    if (isset($_POST["submitEdit"])) {
        ...
        $sql_update1 = "UPDATE `tbl_dormitory` SET `dt_count_room` = '" . $_POST["dt_count_room"] . "' WHERE `tbl_dormitory`.`do_id` = '$do_id';";
        ...
        if (mysqli_query($conn, $sql_update1)) {
            ...
            echo "<script>";
            echo "location ='./editCountRoom.php';";
            echo "</script>";
