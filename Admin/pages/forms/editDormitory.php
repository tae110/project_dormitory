                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ฟอร์มข้อมูลหอพัก
                                <small>เเก้ไขข้อมูลรายละเอียดของหอพัก</small>
                            </h2>
        ...
        ?>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" value="<?=$item["dt_name"]?>" name="dt_name" required
                                                    class="form-control" placeholder="ชื่อหอพัก" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="dt_insurance"
                                                    value="<?=$item["dt_insurance"]?>" required class="form-control"
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="dt_deposit" value="<?=$item["dt_deposit"]?>"
                                                    required class="form-control" placeholder="ค่ามัดจำหอ" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="dt_price" value="<?=$item["dt_price"]?>"
                                                    required class="form-control" placeholder="ราคาหอพัก" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" value="<?=$item["dt_electricity_cost"]?>"
                                                    name="dt_electricity_cost" required class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" value="<?=$item["dt_water_cost"]?>"
                                                    name="dt_water_cost" required class="form-control"
                                                    placeholder="ค่าน้ำ" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" value="<?=$item["dt_orther_cost"]?>"
                                                    name="dt_orther_cost" required class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" name="dt_price" value="<?=$item["dt_price"];?>"
                                                    required class="form-control" placeholder="ค่าอินเตอร์เน็ต" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea rows="6" name="dt_title" required
                                                    ...
                                                    placeholder="รายละเอียดเบื้องต้น ที่เเสดงหน้าเเรก"><?=$item["dt_title"]?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea rows="6" name="dt_detail" required
                                                    class="form-control no-resize"
                                                    placeholder="รายละเอียดหอพัก"><?=$item["dt_detail"]?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea rows="6" name="dt_orther" class="form-control no-resize"
                                                    placeholder="รายละเอียดเเก้ไขข้อมูลเติม"><?=$item["dt_orther"]?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
if ($data["dl_id"] == $item["dl_id"]) {
        ...
        ?>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <button type="submit" name="submitUpdateDormitory"
                                            class="btn btn-primary btn-block btn-lg">เเก้ไขข้อมูลพอพัก</button>
                                    </div>
                                </div>
                                <?php }
...
$dt_id = $_GET["dt_id"];
    ...
    if (isset($_POST["submitUpdateDormitory"])) {
        ...
        $sql1 = "UPDATE `tbl_dormitory` SET `dt_name` = '" . $_POST["dt_name"] . "',
